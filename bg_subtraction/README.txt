TITLE: Rat-following code
AUTHOR: Alexia Lee 
EMAIL: alexia.lee@uqconnect.edu.au
DATE: February 2015
DESCRIPTION: Code to detect moving objects and then identify them as being 
             a rat or an iRat. Eventually this code will evolve to compute
             the relative positions of the iRat and rat and issue commands 
             to the iRat to follow the rat. 
DEPENDENCIES: OpenCV 2.4.10, Opencvblobslib
